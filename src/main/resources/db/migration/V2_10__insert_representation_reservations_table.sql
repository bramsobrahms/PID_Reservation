INSERT INTO `representation_reservations` (`price_id`, `representation_id`, `reservation_id`, `quantity`)
VALUES
    (1, 1, 1, 2),  -- VIP pour la représentation de "Sting en Concert à Paris", réservation 1
    (2, 1, 2, 1),  -- Rang 1 pour la représentation de "Sting en Concert à Paris", réservation 2
    (3, 2, 3, 3),  -- Standard pour la représentation de "Emma Watson dans “La Belle et la Bête”", réservation 3
    (4, 2, 4, 2),  -- Rang 2 pour la représentation de "Emma Watson dans “La Belle et la Bête”", réservation 4
    (5, 3, 5, 1),  -- Privé pour la représentation de "Sasha Waltz - Danse Contemporaine", réservation 5
    (6, 3, 6, 1),  -- Rang 3 pour la représentation de "Sasha Waltz - Danse Contemporaine", réservation 6
    (7, 4, 7, 4),  -- Premium pour la représentation de "David Copperfield - Magie Illusionniste", réservation 7
